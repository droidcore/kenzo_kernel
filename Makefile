...
ARCH		:= arm64
CROSS_COMPILE	:= /home/tanay297/android/toolchain/4.9-64-linaro/bin/aarch64-linux-android-
...
HOSTCC       = $(CCACHE) gcc
HOSTCXX      = $(CCACHE) g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -std=gnu89  -pipe -DNDEBUG -fgcse-las $(GRAPHITE)
...
KBUILD_CFLAGS	+= -O3 $(call cc-disable-warning,maybe-uninitialized,) -fmodulo-sched -fmodulo-sched-allow-regmoves -fno-tree-vectorize -Wno-array-bounds $(OPTIMIZFLAGS) $(GRAPHITE)
endif
